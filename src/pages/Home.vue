  ...
  <section class="py-20 bg-gradient-to-br from-slate-50 to-white">
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="text-center mb-14">
        <h2 class="text-3xl md:text-4xl font-bold text-primeBlue">
          Download Our Product Catalog
        </h2>
        <p class="mt-4 text-gray-600 max-w-2xl mx-auto">
          Explore our complete range of premium sanitary and industrial valve
          solutions in one detailed catalog.
        </p>
      </div>
      ...
      <div class="max-w-4xl mx-auto">
        <div
          class="relative bg-white border border-gray-200 rounded-2xl shadow-lg hover:shadow-2xl transition duration-300 overflow-hidden"
        >
          <!-- Accent Bar -->
          <div
            class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primeBlue to-sky-500"
          ></div>
          ...
          <div class="p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
            ...
            <div class="flex-shrink-0">
              <div
                class="w-20 h-20 rounded-xl bg-primeBlue/10 flex items-center justify-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
                  class="w-16  h-16 text-primeBlue"
                  viewBox="0 0 32 32"
                >
            ...
            <div class="flex-1 text-center md:text-left">
              <h3 class="text-xl md:text-2xl font-semibold text-gray-800">
                Prime Sanitary Ware – Product Catalog
              </h3>
              <p class="mt-3 text-gray-600 leading-relaxed">
                Detailed specifications, sizes, materials, and applications of
                our premium-quality valves and sanitary products.
              </p>

              <!-- Meta -->
              <div
                class="mt-4 flex flex-wrap gap-4 justify-center md:justify-start text-sm text-gray-500"
              >
            ...
            <div class="flex-shrink-0">
              <a
                href="/Prime-sanitary-ware.pdf"
                download
                class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-primeBlue text-white font-medium shadow hover:bg-primeBlue/90 transition"
              >
                Download
                <svg
                  xmlns="http://www.w3.org/2000/svg"
